...
import { Card, Empty, PageTitle } from "@/components/atolye/ui";
import { BILDIRIMLER, BILDIRIM_FILTRELERI } from "@/lib/demo/atolye";
...
export default function BildirimlerClient() {
  ...
  return (
    <div className="max-w-[960px]">
      <PageTitle title="Bildirimler" sub="Hazırlık, malzeme, görev ve yoklama hareketleri." />
            ...
            return (
              <Card key={b.id} className={okundu ? "p-4" : "border-l-[3px] border-l-[#F59E4A] p-4"}>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <Link
                    href={b.href}
                    className="rounded-lg border border-[#DDE5F0] px-3 py-1.5 text-[13px] text-[#243B64] hover:bg-[#F6F9FE]"
                  >
                    İlgili sayfaya git
                  </Link>
                  {!okundu ? (
