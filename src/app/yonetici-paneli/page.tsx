...
export default function YoneticiOzet() {
  ...
  return (
    <div>
      <PageTitle title="Operasyon özeti" sub="Türkiye geneli Güz Dönemi 2026 durumu." />
      ...
      <Card className="mb-[18px]">
        ...
        <Table
          head={["İl", "Toplam görev", "Tamamlanan", "Devam eden", "Geciken", "Hazır atölye", "Tamamlanma oranı"]}
          minWidth={940}
        >
          {ILLER.map((i) => (
      ...
      <div className="grid gap-[18px] xl:grid-cols-2">
        <Card className="p-[18px]">
          ...
          <Link href="/yonetici-paneli/raporlar" className="mt-3.5 inline-block text-[13px] text-[#243B64] underline">
            Raporu görüntüle
          </Link>
        </Card>
